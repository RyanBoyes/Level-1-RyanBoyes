...
images.put(new Integer(KeyEvent.VK_W), "Unknown.jpeg");
images.put(new Integer(KeyEvent.VK_A), "Unknown-1.jpeg");
images.put(new Integer(KeyEvent.VK_S), "Unknown-2.jpeg");
images.put(new Integer(KeyEvent.VK_D), "images.png");
...
int tries = 6;
		...
		if(e.getKeyCode()==imageIndex&&random==0) {
			points++;
			speak("Correct!");
		}
		else {
