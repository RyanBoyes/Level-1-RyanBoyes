...
public class Jepordy implements ActionListener {
	...
	private void start() {
		...
		JPanel panel = createHeader("U.S. Geography");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed==firstButton) {
			askQuestion("What is the third largest State?", "California", 200);
		}
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("What state has the highest average temperature?", "Florida", 400);
		}
		else if(buttonPressed==thirdButton) {
			askQuestion("What state is in the most debt?", "Nebraska", 600);
		}
